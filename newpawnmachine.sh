...
then
	...
	echo "El mensaje del commit será: $mensaje"
        echo "$maquina   ![   ](https://github.com/TheZombrex/machines/blob/main/icons/octicons/Wiki.svg) <a href='https://github.com/TheZombrex/machines/blob/main/docs/$documentacion'>Documentación</a> ![   ](https://github.com/TheZombrex/machines/blob/main/icons/octicons/link.png) <a href='$enlace'>Máquina</a>" >> VulnHubMachines.md
        cat HTBMachines.md > README.md
	echo "" >> README.md
        cat VulnHubMachines.md >> README.md
